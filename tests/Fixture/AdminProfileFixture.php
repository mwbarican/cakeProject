 ...
 *
 */
class AdminProfileFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'admin_profile_ibfk_1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['administrator', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
